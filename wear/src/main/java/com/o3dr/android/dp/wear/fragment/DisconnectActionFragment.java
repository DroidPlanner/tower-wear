 ...
 */
public class DisconnectActionFragment extends BaseActionFragment {
    @Override
    ...
    protected CharSequence getActionLabel() {
        return getText(R.string.disconnect);
    }

    @Override
    protected void onActionClicked() {
        final Context context = getContext();
        context.startService(new Intent(context, WearReceiverService.class).setAction(WearUtils.ACTION_DISCONNECT));
    }
}
