...
public class FollowMeToggleActionFragment extends BaseActionFragment {
    ...
    protected int getActionImageResource() {
        ...
        return followState != null && followState.isEnabled() ? R.drawable.ic_stop_white_48dp : R.drawable
                .ic_play_arrow_white_48dp;
    }

    @Override
    protected CharSequence getActionLabel() {
        final WearFollowState followState = getVehicleFollowState();
        return followState != null && followState.isEnabled() ? "Stop Follow Me" : "Start Follow Me";
    }
    ...
    protected void onActionClicked() {
        ...
        final WearFollowState followState = getVehicleFollowState();
        final String action = followState != null && followState.isEnabled() ? WearUtils.ACTION_STOP_FOLLOW_ME :
                WearUtils.ACTION_START_FOLLOW_ME;
